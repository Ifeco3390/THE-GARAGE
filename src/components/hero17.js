  ...
  return (
    <div className="hero17-header78">
            ...
            {props.content1 ?? (
              <fragment>
                <span className="hero17-text7 thq-body-large">
                  Find the perfect workspace for your needs and schedule your
                  spot hassle-free with our easy-to-use platform.
                </span>
              </fragment>
            )}
          </p>
      ...
      <div>
        ...
        <div>   
      <div dangerouslySetInnerHTML={{ __html: cssContent }} />
    </div>
        </div>
      </div>
    </div>
...
Hero17.defaultProps = {
  image3Src:
    'https://imagizer.imageshack.com/img922/2131/q0DKBe.jpg',
  image8Alt: 'Hero Image',
  image2Src:
    'https://imagizer.imageshack.com/img923/3935/B4Jssu.jpg',
  image6Alt: 'Hero Image',
  image11Src:
    'https://imagizer.imageshack.com/img924/9306/LoNilz.jpg',
  image5Alt: 'Hero Image',
  image1Alt: 'Hero Image',
  image7Src:
    'https://imagizer.imageshack.com/img923/6030/iR4mhT.jpg',
  ...
  image6Src:
    'https://imagizer.imageshack.com/img923/3935/B4Jssu.jpg',
  image12Src:
    'https://imagizer.imageshack.com/img923/5778/1ZMg0s.jpg',
  image3Alt: 'Hero Image',
  image9Src:
    'https://imagizer.imageshack.com/img924/3671/p6iSzG.jpg',
  ...
  image8Src:
    'https://imagizer.imageshack.com/img924/9306/LoNilz.jpg',
  image5Src:
    'https://imagizer.imageshack.com/img924/813/eddx5B.jpg',
  image4Src:
    'https://imagizer.imageshack.com/img922/2131/q0DKBe.jpg',
